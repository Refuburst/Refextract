...
#         return("References in the PDF are not in alphabetical order")
    ...
    try:
        ...
        return "Error: 'author' column not found in the DataFrame"
...
def count_surnamesx(reference):
   parsed_authors = authors.parseString(reference)
...
def process_other_functions(text):
    ...
    # auth_count = HTML(auth_year.to_html(classes='table table-stripped').encode('utf-8').decode('utf-8'))
